...
class HttpCacheTest extends HttpCacheTestCase
{
    ...
    public function testEsiCacheSendsTheLowestTtlForHeadRequests()
    {
        $responses = array(
            array(
                'status' => 200,
                'body' => 'I am a long-lived layout response, but I embed a short-lived resource: <esi:include src="/foo" />',
                'headers' => array(
                    'Cache-Control' => 's-maxage=300',
                    'Surrogate-Control' => 'content="ESI/1.0"',
                ),
    ...
    public function testEsiCacheForceValidationForHeadRequests()
    {
        $responses = array(
            array(
                'status' => 200,
                'body' => 'I am the layout response and use expiration caching, but I embed another resource: <esi:include src="/foo" />',
                'headers' => array(
                    'Cache-Control' => 's-maxage=300',
                    'Surrogate-Control' => 'content="ESI/1.0"',
                ),
