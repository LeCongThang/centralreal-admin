...
<section class="content">
    <div class="row">
        <div class="col-md-12">
                {{ Form::open(['url' => $isEdit ? "slider/update/$slider->id": 'slider/storage', 'method' => 'POST', 'enctype'=>'multipart/form-data', 'spellcheck'=>'false']) }}
                <div class="box">
                    <div class="box-header">
                        <a href="{{url('slider')}}" class="btn btn-primary"><i class="fa fa-arrow-left"></i>&nbsp;&nbsp;&nbsp;Quay lại</a>
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label for="exampleInputPassword1">Hình ảnh (1100 x 600px)</label>
                                ...
                                <div class="input-group image-preview" style="margin-top: 10px">
                                    <input placeholder="" id="text-image1" type="text" value="{{$isEdit? $slider->image:''}}" class="form-control image-preview-filename" disabled="disabled">
    ...
    <script>
        ...
        $('.editors').each( function () {
            CKEDITOR.replace(this.id, {
                filebrowserUploadUrl: '/uploader/slider',
                filebrowserBrowseUrl:'{{URL::asset('')}}folder/slider'
            });
        });
    </script>
@endsection
