...
<div class="container">
        ...
        <div class="col-sm-6">
            <form class="navbar-form navbar-left" action="{{URL::asset('')}}uploadfile"  method="post"
                ...
                <div class="form-group">
                    ...
                    <input type="submit" value="Tải lên" class="btn btn-info upload-image" data-folder="project"/>
                </div>
    ...
    <div class="row" id="img-project">
        @foreach($FileNames as $i)

            <div class="col-xs-6 col-md-2" id="{{$i['filename']}}">
                <div class="thumbnail">
                    <a href="#" class="chooseimg">
                        <img src="{{URL::asset('uploads/project')}}/{{$i['basename']}}" class="img-responsive">
                    </a>
                    <div class="caption">
                        <p class="text-center">
                            <a href="{{URL::asset('')}}deletefile/project/{{$i['filename']}}" class="btn btn-danger btn-xs deletebtn" role="button">Delete</a>
                        </p>
                    </div>
                </div>
            </div>
